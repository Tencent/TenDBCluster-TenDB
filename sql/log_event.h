...
#define LOG_EVENT_IS_ROW_V2(type) \
    ((type >= binary_log::WRITE_ROWS_EVENT && type <= binary_log::DELETE_ROWS_EVENT) || \
     (type >= binary_log::WRITE_ROWS_COMPRESSED_EVENT && type <= binary_log::DELETE_ROWS_COMPRESSED_EVENT))
