...
CREATE TABLE IF NOT EXISTS xa_commit_log (id bigint(20) NOT NULL, xid char(128) NOT NULL, commit_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (id), KEY kx (xid)) ENGINE=InnoDB DEFAULT CHARSET=latin1;
